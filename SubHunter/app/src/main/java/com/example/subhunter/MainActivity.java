 ...
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Tell the Android to set our drawing as the view for this app
 ...
 */
    ...
    void draw()
    {
        ...
        //Draw the vertical lines of the gird
...
void takeshot(float touchX,float touchY)
{
    ...
    //Convert the float screen coordinates into int coordinates
...
void printDebuggingText()
{
    ...
    Log.d("numberHorizentalPixels"," "+numberHorizontalPixels);
